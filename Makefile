...
config:
	...
	@echo "  NETWORK_DELAY_VARIANCE_MS: $${NETWORK_DELAY_VARIANCE_MS:-0} (legacy variance)"
	@echo "  NETWORK_DELAY_DISTRIBUTION: $${NETWORK_DELAY_DISTRIBUTION:-normal} (legacy distribution)"
	@echo ""
	@echo "  NETWORK_DELAY_SIM_TO_HW_MS: $${NETWORK_DELAY_SIM_TO_HW_MS:-0} (sim→hw)"
	@echo "  NETWORK_DELAY_SIM_TO_HW_VARIANCE_MS: $${NETWORK_DELAY_SIM_TO_HW_VARIANCE_MS:-0} (sim→hw variance)"
	@echo "  NETWORK_DELAY_SIM_TO_HW_DISTRIBUTION: $${NETWORK_DELAY_SIM_TO_HW_DISTRIBUTION:-normal} (sim→hw distribution)"
	@echo ""
	@echo "  NETWORK_DELAY_HW_TO_SIM_MS: $${NETWORK_DELAY_HW_TO_SIM_MS:-0} (hw→sim)"
	@echo "  NETWORK_DELAY_HW_TO_SIM_VARIANCE_MS: $${NETWORK_DELAY_HW_TO_SIM_VARIANCE_MS:-0} (hw→sim variance)"
	@echo "  NETWORK_DELAY_HW_TO_SIM_DISTRIBUTION: $${NETWORK_DELAY_HW_TO_SIM_DISTRIBUTION:-normal} (hw→sim distribution)"
	@echo ""
