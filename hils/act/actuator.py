import os, socket, csv, pathlib, sys
sys.path.append('/app')
...
log.writerow(['step_id','t_act_recv_ns','t_act_send_ns','missing_cmd','note','result'])
    ...
    with conn:
        ...
        while True:
            try:
                ...
                log.writerow([step_id, t_recv, t_send, False, 'addition_processed', result])
                log_file.flush()
