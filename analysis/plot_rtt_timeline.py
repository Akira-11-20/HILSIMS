...
def load_and_process_data(log_dir):
    ...
    valid_df["elapsed_time_s"] = (
        valid_df["t_sim_send_ns"] - start_time_ns
    ) / 1_000_000_000
...
def main():
    ...
    parser.add_argument(
        ...
        "-o",
        type=str,
        help="Output PNG file path (default: save to log directory)",
    )
    ...
    try:
        ...
        # プロット作成
        create_rtt_timeline_plot(df, output_file)
